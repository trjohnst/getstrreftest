...
void main()
{
    ...
    string sBaseItemNameStrRef = Get2DAString("baseitems", "Name", 0); // short sword

    SendMessageToPC(oPC, "sBaseItemNameStrRef " + sBaseItemNameStrRef);

    int nBaseItemNameStrRef = StringToInt(sBaseItemNameStrRef);

    SendMessageToPC(oPC, "nBaseItemNameStrRef " + IntToString(nBaseItemNameStrRef));

    string sBaseItemName = GetStringByStrRef(nBaseItemNameStrRef);

    SendMessageToPC(oPC, "sBaseItemName " + sBaseItemName);
}
